...
# I ran this and got minkowskiEngine installed!!!!! 
export CC=/usr/bin/gcc-11
export CXX=/usr/bin/g++-11
export CUDAHOSTCXX=/usr/bin/g++-11   # important for nvcc host compiler
export TORCH_CUDA_ARCH_LIST="7.5"    # since you compile for sm_75 in logs
